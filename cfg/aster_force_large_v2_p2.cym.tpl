...
[[ L = range(22, 41, 3) ]]% [[L]]
new [[round(500/L)]] centrosome
{
    solid = core
    radius = 0.3
    point1 = center, 0.3
    fibers = [[L]], microtubule, ( length = 5;  end_state = green, green;)
}
...
set hand kinesin
{
    binding_rate = 10 % originally 100
    binding_range = 0.1 % og 0.01
    unbinding_rate = 0
    unbinding_force = 3
    
    activity = move
    unloaded_speed = -2 %og -10
    stall_force = [[X]]
...
new 1000 graftedK { position=surface; placement = surface,, ( y > 9.99999;); }        %used to be 200 grafted
new 1000 graftedD { position=surface; placement = surface,, ( y < -9.99999;);}
